...
|      树莓派 4B      | [Lean OpenWRT for Raspberry Pi 4](https://github.com/SuLingGG/OpenWrt-Rpi/actions/workflows/build-rpi4-lean-openwrt.yml?query=is%3Asuccess) | [Official Modded OpenWrt by SuLingGG](https://github.com/SuLingGG/OpenWrt-Rpi/actions/workflows/build-rpi4-offical-openwrt.yml?query=is%3Asuccess)
